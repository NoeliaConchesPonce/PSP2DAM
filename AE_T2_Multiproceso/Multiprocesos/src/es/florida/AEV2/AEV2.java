...
public class AEV2 {
	...
	/* Metode: main
	*Descripcio: extrau linea per linea del fitxer i calcula els missatge per el numero de cores que tingues.
	*			 Extrau el temps que dura la aplicacio i la mitja de cada proces.
...
*/
	...
	*Descripcio: llig el contingut del fitxer y el retorna en un array de tipus string per poder actuar amb ell
	*Parametres d'entrada: fichero.
...
*/
	...
	/* Metode: lanzarSumador
	*Descripcio: afegeix les variables ya calculades en el sumador
